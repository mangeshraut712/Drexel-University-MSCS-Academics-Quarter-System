...
public class Corporation {
	...
	Engineers engineers = new Engineers(null);
	Managers managers = new Managers(null);
	private String name;
	...
	public void start(ArbitraryStatisticsServiceWrapper arbitraryStatisticsServiceWrapper) {
		List<String> engineerDetails = engineers.engineersReport();
		...
		List<String> managersDetails = managers.managersReport();
