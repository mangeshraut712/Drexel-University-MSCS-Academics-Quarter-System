...
[0x00]	No,	0x1b,	'\'',	',',	'.',	'p',	'y',	'f',
[0x08]	'g',	'c',	'r',	'l',	'/',	'=',	'\b',	'\t',
[0x10]	'a',	'o',	'e',	'u',	'i',	'd',	'h',	't',
[0x18]	'n',	's',	'-',	'q',	'\n',	Ctrl,	';',	'j',
[0x20]	'k',	'x',	'b',	'm',	'w',	'v',	'z',	Shift,
[0x28]	'\'',	'`',	Shift,	'\\',	'z',	'x',	'c',	'v',
[0x30]	'b',	'n',	'm',	',',	'.',	'/',	Shift,	'*',
[0x38]	Latin,	' ',	Ctrl,	KF|1,	KF|2,	KF|3,	KF|4,	KF|5,
[0x40]	KF|6,	KF|7,	KF|8,	KF|9,	KF|10,	Num,	Scroll,	'7',
...
i8042intr(Ureg*, void*)
{
	...
	static Rune *kbtabptr = kbtab;
	static Rune *kbtabshiftptr = kbtabshift;
	...
	if(!(c & (Spec|KF))){
		if(ctl){
			...
			if(alt && c == '\\'){
				if(kbtabptr == kbtab) {
    					// Switch to the alternative mapping
    					kbtabptr = kbtabdvorak;
    					kbtabshiftptr = kbtabdvorakshift;
				} else {
    					// Use the default mapping
    					kbtabptr = kbtab;
    					kbtabshiftptr = kbtabshift;
				}
				return;
			}
			c &= 0x1f;
