...
class Cube:
    ...
    def norm(self, string="WWWW RRRR GGGG YYYY OOOO BBBB"):
        ...
        # this function operates the swapping to maintain the desired position of the flatten array
    ...
    def Swap(self, string):
        ...
        # display the cube in the desired format
    ...
    def shuffle(self, n, string="WWWW RRRR GGGG YYYY OOOO BBBB"):
        ...
        # divide a given array into 3 parts

    def divide_in_three(self, array):
        parent = []
        child = []
        j = 0
        for i in range(0, len(array)):
            if j < 3:
                j += 1
                child.append(array[i])
            if j == 3:
                j = 0
                parent.append(child)
                child = []
            if i == len(array) - 1 and len(array) % 3 != 0:
                parent.append(child)
        return parent
    ...
    def print_multiple_strings(self, array):
        ...
        if len(array) == 1:
            ...
            newString = ""
            for i in range(0, len(string1)):
                newString += string1[i] + "  " + string2[i] + "  " + string3[i] + "\n"
        return newString
